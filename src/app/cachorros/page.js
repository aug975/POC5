// este arquivo gera a pagina de imagens especificas de CACHORROS no site
...
export default function Home() {
  ...
  // no retorno da funcao temos o HTML que sera construido na pagina 
    ...
    // <ImgAnimal/> finalmente, tres imagens de cachorros inclusas por meio de componentes ImgAnimal
  return (
    <div>
      <div className="top">
