// este arquivo gera a pagina de imagens especificas de GATOS no site
...
export default function Home() {
  ...
  // no retorno da funcao temos o HTML que sera construido na pagina 
    ...
    // <ImgAnimal/> finalmente, tres imagens de gatos inclusas por meio de componentes ImgAnimal
  return (
    <div>
      <div className="top">
        ...
        <h1 className="logo">Imagens de Gatos</h1>
      ...
      <ImgAnimal animal="gato" number="2"/>
      <ImgAnimal animal="gato" number="3"/>
    </div>
  );
}
